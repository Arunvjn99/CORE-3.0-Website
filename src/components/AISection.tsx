...
function LoanCalculator() {
  ...
  return (
    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }}
      ...
      style={{ background: "linear-gradient(135deg, rgba(59,130,246,0.10), rgba(139,92,246,0.06))", border: "1px solid rgba(59,130,246,0.22)" }}>
...
function AIFeatureCards() {
  const cards = [
    { title: "Loan Calculator", desc: "Instant eligibility + live payment preview", color: "#3B82F6", icon: "M12 6v6m0 0v6m0-6h6m-6 0H6" },
    { title: "Contribution Impact", desc: "See take-home pay change in real time", color: "#22D3EE", icon: "M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" },
    { title: "Plan Comparison", desc: "Traditional vs Roth — AI tax analysis", color: "#8B5CF6", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
    ...
    <>
      ...
      <section id="ai" ref={ref} className="section-dark relative py-28 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none" style={{
          background: "radial-gradient(ellipse 50% 50% at 25% 50%, rgba(37,99,235,0.14) 0%, transparent 60%), radial-gradient(ellipse 40% 40% at 80% 40%, rgba(139,92,246,0.12) 0%, transparent 55%)"
        }} />
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}}
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full mb-6" style={{ background: "rgba(139,92,246,0.08)", border: "1px solid rgba(139,92,246,0.22)" }}>
                <div className="w-1.5 h-1.5 rounded-full bg-[#A78BFA]" style={{ boxShadow: "0 0 8px #A78BFA" }} />
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}}
              ...
              <div className="relative rounded-2xl border border-white/[0.08] overflow-hidden shadow-float gradient-border" style={{ background: "linear-gradient(180deg,#0A0E27,#0F1531)" }}>
                {/* Header */}
                <div className="px-5 py-3.5 border-b border-white/[0.04] flex items-center gap-3">
                  <div className="relative">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center shadow-glow-purple" style={{ background: "linear-gradient(135deg,#3B82F6,#22D3EE,#8B5CF6)" }}>
                    ...
                    <div className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full bg-[#10B981] border-2 border-[#0A0E27]" />
                  </div>
                  <div>
                  ...
                  <AnimatePresence>
                    {msgCount >= 1 && (
                      <motion.div initial={{ opacity: 0, y: 16, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }}
                        ...
                        <div className="rounded-2xl rounded-br-md px-4 py-2.5 text-[13px] text-white font-medium" style={{ background: "linear-gradient(120deg,#3B82F6,#22D3EE,#8B5CF6)", boxShadow: "0 4px 16px rgba(59,130,246,0.3)" }}>
                          {chatMessages[0].text}
                        </div>
                      </motion.div>
                    )}
                ...
                <div className="px-5 pb-5">
                  <div className="flex items-center gap-2 rounded-xl border border-white/[0.08] px-4 py-3" style={{ background: "rgba(255,255,255,0.03)" }}>
                    ...
                    <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ background: "linear-gradient(135deg,#3B82F6,#8B5CF6)", boxShadow: "0 0 16px rgba(59,130,246,0.5)" }}>
